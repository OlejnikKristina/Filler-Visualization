$(document).ready(function()
{
	...
	{
		$("#map_src").text("Insert all Filler's battle here\
									\
		1) ./filler_vm -p1 player1 -p2 player2 -v -f maps/map01 >> filler_battle.txt\
									\
		2) Open filler_battle.txt, copy file contents\
									\
		3) Insert file content here");
	};

	insert_usage();

	$("#map_src").click(function(){
